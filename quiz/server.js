        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fs_1.promises.readFile(path_1.default.resolve(__dirname, dataFile))];
                case 1:
                    data = _a.sent();
...
app.get("/read/username/:username", function (req, res) {
    var _a;
    // edited here
...
app.post("/write/adduser", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var newuser, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                newuser = req.body;
                users.push(newuser);
                return [4 /*yield*/, fs_1.promises.writeFile(path_1.default.resolve(__dirname, dataFile), JSON.stringify(users))];
            case 1:
                _a.sent();
            ...
            case 2:
                err_2 = _a.sent();
                console.log("Failed to write:", err_2);
